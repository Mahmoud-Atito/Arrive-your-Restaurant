...
class ViewController: UIViewController, CLLocationManagerDelegate, GMSMapViewDelegate, GMSAutocompleteViewControllerDelegate, UITextFieldDelegate {
   ...
   // default map display camera
    ...
    //show the last location if there is no updating in location
    ...
    func mapView(_ mapView: GMSMapView, didTapInfoWindowOf marker: GMSMarker) {
        ...
        let tag = customMarkerView.tag //  is like an identifier to an object with default value of 0
    ...
    func setupViews() {
        ...
        setupTextField(textField: txtFieldSearch, img : #imageLiteral(resourceName: "map-pin 2"))
